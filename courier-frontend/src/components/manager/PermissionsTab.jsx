...
const PermissionsTab = () => {
  const [staffPermissions, setStaffPermissions] = useState([
    { id: 1, name: "Sarah Johnson", role: "Delivery Driver", canEdit: true, canRemove: false },
    { id: 2, name: "Michael Chen", role: "Warehouse Staff", canEdit: true, canRemove: true },
    { id: 3, name: "Emily Rodriguez", role: "Delivery Driver", canEdit: false, canRemove: false },
  ]);
    ...
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-gray-200">
      ...
      <div className="divide-y divide-gray-200">
        {staffPermissions.map(staff => (
          <div key={staff.id} className="flex flex-col md:flex-row md:items-center justify-between py-4">
            <div>
